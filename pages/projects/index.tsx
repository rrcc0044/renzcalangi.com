          ...
          <div className="mx-auto max-w-2xl lg:max-w-5xl">
            <header className="max-w-2xl">
              <h1 className="text-4xl font-bold tracking-tight text-zinc-800  sm:text-5xl">
                Things I’ve been part of trying to put my dent in the universe.
              </h1>
            ...
            <div className="mt-16 sm:mt-20">
              ...
              >
                ...
                <li className="group relative flex flex-col items-start">
                  ...
                  <p className="relative z-10 mt-2 text-sm text-zinc-600 ">
                    Australian Bucket List is a unique immersive travel platform
                    showcasing the very best destinations and travel experiences
                    in Australia.
                  </p>
                  <p className="relative z-10 mt-6 flex text-sm font-medium text-zinc-400 transition group-hover:text-teal-500 ">
                    <svg
                ...
                <li className="group relative flex flex-col items-start">
                  ...
                  <h2 className="mt-6 text-base font-semibold text-zinc-800 ">
                    ...
                    >
                      <span className="absolute -inset-x-4 -inset-y-6 z-20 sm:-inset-x-6 sm:rounded-2xl"></span>
                      <span className="relative z-10">Besso</span>
                    </a>
                  </h2>
                  <p className="relative z-10 mt-2 text-sm text-zinc-600 ">
                    Besso leverages AI and trade expertise to automate trade
                    regulation monitoring, delivering real-time insights and
                    significant savings.
                  </p>
                  <p className="relative z-10 mt-6 flex text-sm font-medium text-zinc-400 transition group-hover:text-teal-500 ">
                    <svg
                    ...
                    <span className="ml-2">besso.com</span>
                  </p>
                </li>
              </ul>
            </div>
